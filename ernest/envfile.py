...
FIELDS: list[tuple[str, str, str, bool, str]] = [
    ...
    ("CANVAS_TOKEN", "Canvas access token", "Canvas", True, "canvas token"),
    ("GOOGLE_CREDENTIALS_DIR", "Google credentials dir", "Gmail", False, "./state/google"),
    ("ERNEST_ACCOUNTS", "Gmail accounts (comma-sep)", "Gmail", False, "work,school,business"),
